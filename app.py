...
# =========================================================
PROVIDER_NAME = "高如慧"
PHASE2_TUTORIAL_URL = "https://www.youtube.com/watch?v=dQw4w9WgXcQ"  # 若沒有可先留著

# =========================================================
# Session State 初始化
# =========================================================
for k in [
    "ad_account", "pixel", "fanpage", "bm",
    "fanpage_url", "landing_url",
    "comp1", "comp2", "comp3",
...
# 回傳訊息（即時生成）
# =========================================================
def s(x): return x if str(x).strip() else "（未填）"
